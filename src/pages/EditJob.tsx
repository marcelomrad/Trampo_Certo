...
import { UploadIcon, FileTextIcon, XIcon, CheckCircleIcon, AlertCircleIcon } from 'lucide-react';
...
export function EditJob() {
  ...
  useEffect(() => {
    if (job) {
      setFormData({
        ...
        accessibility: job.accessibility.join('\n'),
        schedule: job.schedule || []
      });
      // Simular documentos existentes (em produção, viriam da API)
      setAccessibilityDocs([{ name: 'documento_acessibilidade.pdf', size: '2.1 MB', verified: true }]);
    }
  }, [job]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Determinar selos de acessibilidade
    ...
    const updatedJob = {
      ...
      category: job?.category || 'Tecnologia',
    ...
    return (
      <div className="w-full bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/empresa/dashboard')} className="text-blue-600 hover:text-blue-700">
            Voltar ao dashboard
          </button>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Descreva as responsabilidades e o que o candidato fará..."
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Liste os recursos de acessibilidade disponíveis..."
            ...
            <div className="flex space-x-4">
              ...
              <button
                type="submit"
                className="flex-1 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 flex items-center justify-center space-x-2"
              >
